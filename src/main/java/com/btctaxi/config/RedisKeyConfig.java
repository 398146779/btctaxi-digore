...
public interface RedisKeyConfig {
    ...
    String CHANGE_RATE_MINUTE = "CHANGE_RATE_MINUTE";
    String CHANGE_TAXI_RATE_MINUTE = "CHANGE_TAXI_RATE_MINUTE";
    ...
    enum CommonConfig {
        ...
        MINER_OWNER_ID_LIST,//矿池所有人, ID 逗号隔开
        MINER_OWNER_RATE_RATE,//矿池所有人, 比例
