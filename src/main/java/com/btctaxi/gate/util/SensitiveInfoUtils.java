...
//            return email;
//        else
//        return StringUtils.rightPad(StringUtils.left(email, 1), 4, "*").concat("@***").concat(StringUtils.mid(email, index, StringUtils.length(email)));
        int indexOf = StringUtils.lastIndexOf(email, "@");
        if (indexOf < 4) {
            return StringUtils.left(email, 1).concat("***@***").concat(StringUtils.substring(email, index, email.length()));
        }
        return StringUtils.left(email, 1).concat("***").concat(String.valueOf(email.charAt(indexOf - 1))).concat("@***").concat(StringUtils.substring(email, index, email.length()));
...
//        System.out.println(SensitiveInfoUtils.email("a@qq.com1"));
//        System.out.println(SensitiveInfoUtils.email("baa@qq.org"));
//        System.out.println(SensitiveInfoUtils.email("baa1@qq.org"));
//        System.out.println(SensitiveInfoUtils.email("ba@qq.org"));
//        System.out.println(SensitiveInfoUtils.email("Fha123@qq.ahah"));
//        System.out.println(SensitiveInfoUtils.email("hong.feng@qq.co3m"));
//
//    }
}