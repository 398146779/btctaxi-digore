...
public class GeetestLib {
    ...
    public int enhencedValidateRequest(String challenge, String validate, String seccode, HashMap<String, String> data) {
        ...
        String return_seccode = jsonObject.getString("seccode");
        return_seccode = return_seccode == null ? "" : return_seccode;
    ...
    public int geetestSecondCheck(int gt_server_status_code, String geetest_challenge, String geetest_validate, String geetest_seccode, String ip) {
        int gtResult;
        if (gt_server_status_code == 1) {
            HashMap<String, String> map = new HashMap<>();
            map.put("ip_address", ip);
            gtResult = enhencedValidateRequest(geetest_challenge, geetest_validate, geetest_seccode, map);
        } else
            gtResult = failbackValidateRequest(geetest_challenge, geetest_validate, geetest_seccode);
        return gtResult;
    }
